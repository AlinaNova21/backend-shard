...
var BadgePaths = {
  ...
  11: {
    calc (param) {
      var a1 = 30; var a2 = 30; var x = 50 - 50 * Math.cos(Math.PI / 4); var y = 50 - 50 * Math.sin(Math.PI / 4)
  ...
  18: {
    calc (param) {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        var path = `M ${50 + 100 * Math.cos(angle1)} ${50 + 100 * Math.sin(angle1)}
                            L ${50 + 100 * Math.cos(angle2)} ${50 + 100 * Math.sin(angle2)}
...
function getBadgeSvg (badgeInfo) {
  ...
  var color2 = _.isString(badgeInfo.color2) ? badgeInfo.color2 : colors[badgeInfo.color2].rgb

  var color3 = _.isString(badgeInfo.color3) ? badgeInfo.color3 : colors[badgeInfo.color3].rgb
